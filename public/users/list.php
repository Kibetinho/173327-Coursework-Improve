...
<head>
    ...
    <style>
        ...
        a.btn { padding: 6px 10px; background: #1976d2; color: #fff; text-decoration: none; border-radius: 4px; margin-right: 6px; }
    </style>
</head>
<body>
    <h2><?= $limitToAuthors ? 'Manage Authors' : 'Manage Users' ?></h2>
    <p>
        <a class="btn" href="add.php<?= $limitToAuthors ? '?type=Author' : '' ?>">Add <?= $limitToAuthors ? 'Author' : 'User' ?></a>
